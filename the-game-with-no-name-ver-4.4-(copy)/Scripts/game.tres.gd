...
@onready var bossLabel: Label = $Boss/Label
...
func check_for_dialog(blackBox: bool, options: bool, speaker: String, dialog: Array) -> void:
...
func change_boss_label(boss_label: String) -> void: 
	bossLabel.text = boss_label
